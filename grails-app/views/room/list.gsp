			...
			<table>
				<thead>
					<tr>
						...
						<g:sortableColumn property="roomNbr" title="${message(code: 'room.roomNbr.label', default: 'Room Nbr')}" />
				...
				<g:each in="${roomInstanceList}" status="i" var="roomInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td><g:link action="show" id="${roomInstance.id}">${fieldValue(bean: roomInstance, field: "roomNbr")}</g:link></td>
